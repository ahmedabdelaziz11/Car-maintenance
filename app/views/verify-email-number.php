...
<div class="container my-5">
    <h1 class="text-primary mb-4"><?= __('Verify your email number') ?></h1>
...
<script>
    document.getElementById('verifyPhoneForm').addEventListener('submit', function(event) {
        ...
        fetch('<?= BASE_URL . "/home/verifyEmail" ?>', {
            method: 'POST',
            body: formData,
        })
        ...
        .catch(error => {
            ...
            document.getElementById('responseMessage').innerHTML = `<div class="alert alert-danger">An error occurred while verifying your email.</div>`;
        });
    });
</script>
